...
def __main__(*args):
    ...
    if not plugin_config.GetConfigEntryWithDefault("OnPostTaskPaths", ""):
        return
    ...
    path = ""
    adding_paths = plugin_config.GetConfigEntryWithDefault("OnPostTaskPaths",
                                                           "").strip()
    ...
    cxt.data["deadlineEvent"] = "OnPostTask"
